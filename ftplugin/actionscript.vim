...
" switch programs, switch back to absolute line numbers for reference
au FocusLost * :set number
au FocusGained * :set relativenumber

" use absolute line numbers in insert mode, switch back to relative for
...
set makeprg=bingomake
set errorformat=%EERR:%f(%l):\ col:\ %c\ %m,%-G%.%#
